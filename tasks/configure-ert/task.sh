...
cf_resources=$(
  jq -n \
    ...
    "cloud_controller": { "internet_connected": $internet_connected, "instances_best_fit": 1 },
    "cloud_controller_worker": { "internet_connected": $internet_connected, "instances_best_fit": 1 },
    "consul_server": { "internet_connected": $internet_connected },
    "credhub": { "internet_connected": $internet_connected },
    "diego_brain": { "internet_connected": $internet_connected, "instance_type_best_fit": "t2.micro" },
    "diego_cell": { "internet_connected": $internet_connected, "instances_best_fit" : 1 },
    "diego_database": { "internet_connected": $internet_connected, "instances_best_fit" : 1 },
    "doppler": { "internet_connected": $internet_connected, "instances_best_fit" : 1 },
    "ha_proxy": { "internet_connected": $internet_connected },
    "loggregator_trafficcontroller": { "internet_connected": $internet_connected, "instances_best_fit" : 1 },
    "mysql": { "instances": 0, "internet_connected": $internet_connected, "instances_best_fit" : 1 },
    "mysql_monitor": { "instances": 0, "internet_connected": $internet_connected },
    "mysql_proxy": { "instances": 0, "internet_connected": $internet_connected, "instances_best_fit" : 1 },
    "nats": { "internet_connected": $internet_connected, "instances_best_fit" : 1 },
    "nfs_server": { "internet_connected": $internet_connected },
    "router": { "internet_connected": $internet_connected, "instances_best_fit" : 1 },
    "syslog_adapter": { "internet_connected": $internet_connected, "instances_best_fit" : 1 },
    "syslog_scheduler": { "internet_connected": $internet_connected, "instances_best_fit" : 1 },
    "tcp_router": { "internet_connected": $internet_connected },
    "uaa": { "internet_connected": $internet_connected, "instances_best_fit" : 1 }
    }
